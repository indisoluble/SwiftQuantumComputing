//
//  CircuitStatevectorAdapter.swift
...
struct CircuitStatevectorAdapter {

    // MARK: - CircuitStatevector properties
    ...
    enum InitError: Error {
        ...
        case statevectorCountHasToBeAPowerOfTwo
    }

    init(statevector: Vector) throws {
        guard statevector.count.isPowerOfTwo else {
