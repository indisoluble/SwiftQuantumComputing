...
struct AnyCircuitViewPosition {
    ...
    private let factory: CircuitViewPosition

    // MARK: - Internal init methods

    init<T: CircuitViewPosition & Hashable>(circuitViewPosition: T) {
...
extension AnyCircuitViewPosition: Hashable {}

// MARK: - AnyHashableContainer methods

extension AnyCircuitViewPosition: AnyHashableContainer {}

// MARK: - CircuitViewPosition methods

extension AnyCircuitViewPosition: CircuitViewPosition {
