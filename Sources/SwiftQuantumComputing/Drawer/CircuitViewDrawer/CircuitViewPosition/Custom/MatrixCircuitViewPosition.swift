//
//  MatrixCircuitViewPosition.swift
...
struct MatrixCircuitViewPosition {
    ...
    init(connected: CircuitViewPositionConnectivity.Target = .none, showText: Bool = true) {
...
extension MatrixCircuitViewPosition: Hashable {}

// MARK: - CircuitViewPosition methods

extension MatrixCircuitViewPosition: CircuitViewPosition {
