//
//  HadamardCircuitViewPosition.swift
...
struct HadamardCircuitViewPosition {
    ...
    init(connected: CircuitViewPositionConnectivity.Target = .none) {
...
extension HadamardCircuitViewPosition: Hashable {}

// MARK: - CircuitViewPosition methods

extension HadamardCircuitViewPosition: CircuitViewPosition {
