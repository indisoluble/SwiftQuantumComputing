//
//  RotationPositionViewFactory.swift
...
struct RotationPositionViewFactory {
    ...
    init(axis: Gate.Axis,
         radians: Double,
         connected: PositionViewFactoryConnectivity.Target = .none) {
        self.axis = axis
...
extension RotationPositionViewFactory: Hashable {}

// MARK: - PositionViewFactory methods

extension RotationPositionViewFactory: PositionViewFactory {
    func makePositionView(frame: CGRect) -> PositionView {
        ...
        view.text = String(format: "R%@(%@)", suffix, String(positionViewRadians: radians))
