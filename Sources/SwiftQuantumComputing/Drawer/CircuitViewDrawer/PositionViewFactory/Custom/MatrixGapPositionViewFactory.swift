//
//  MatrixGapPositionViewFactory.swift
...
struct MatrixGapPositionViewFactory {

    // MARK: - Private properties

    private let connected: PositionViewFactoryConnectivity.Gap

    // MARK: - Internal init methods

    init(connected: PositionViewFactoryConnectivity.Gap = .none) {
...
extension MatrixGapPositionViewFactory: Hashable {}

// MARK: - PositionViewFactory methods

extension MatrixGapPositionViewFactory: PositionViewFactory {
