//
//  MatrixPositionViewFactory.swift
...
struct MatrixPositionViewFactory {
    ...
    init(connected: PositionViewFactoryConnectivity.Target = .none, showText: Bool = true) {
...
extension MatrixPositionViewFactory: Hashable {}

// MARK: - PositionViewFactory methods

extension MatrixPositionViewFactory: PositionViewFactory {
