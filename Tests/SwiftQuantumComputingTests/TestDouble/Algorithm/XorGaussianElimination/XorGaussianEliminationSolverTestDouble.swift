//
//  XorGaussianEliminationSolverTestDouble.swift
...
final class XorGaussianEliminationSolverTestDouble {

    // MARK: - Internal properties

    private (set) var findActivatedVariablesInEquationsCount = 0
    private (set) var lastFindActivatedVariablesInEquationsEquations: Set<Set<Int>>?
    var findActivatedVariablesInEquationsResult: [[Int]] = []
}

// MARK: - XorGaussianEliminationSolver methods

extension XorGaussianEliminationSolverTestDouble: XorGaussianEliminationSolver {
