//
//  CircuitDensityMatrixFactoryTestDouble.swift
...
final class CircuitDensityMatrixFactoryTestDouble {
...
extension CircuitDensityMatrixFactoryTestDouble: CircuitDensityMatrixFactory {
    func makeDensityMatrix(matrix: Matrix) -> Result<CircuitDensityMatrix & CircuitProbabilities, MakeDensityMatrixError> {
        ...
        if let makeDensityMatrixResult = makeDensityMatrixResult {
            return .success(makeDensityMatrixResult)
        }

        return .failure(makeDensityMatrixError)
    }
}
