//
//  CircuitStatevectorFactoryTestDouble.swift
...
final class CircuitStatevectorFactoryTestDouble {
...
extension CircuitStatevectorFactoryTestDouble: CircuitStatevectorFactory {
    func makeStatevector(vector: Vector) -> Result<CircuitStatevector & CircuitProbabilities, MakeStatevectorError> {
        ...
        if let makeStatevectorResult = makeStatevectorResult {
            return .success(makeStatevectorResult)
        }

        return .failure(makeStatevectorError)
    }
}
