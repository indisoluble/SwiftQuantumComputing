...
public func allTests() -> [XCTestCaseEntry] {
    return [
        ...
        testCase(FixedControlledGate_SimulatorControlledMatrixAdapterFactoryTests.allTests),
        testCase(FixedOracleGate_SimulatorControlledMatrixAdapterFactoryTests.allTests),
        ...
        testCase(SimulatorControlledMatrixExtractorTests.allTests),
