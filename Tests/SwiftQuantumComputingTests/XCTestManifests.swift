...
public func allTests() -> [XCTestCaseEntry] {
    return [
        ...
        testCase(DirectStatevectorControlledFilterTests.allTests),
        testCase(DirectStatevectorOracleFilterTests.allTests),
        ...
        testCase(FixedControlledGate_SimulatorOracleMatrixAdapterFactoryTests.allTests),
        testCase(FixedOracleGate_SimulatorOracleMatrixAdapterFactoryTests.allTests),
        ...
        testCase(SimulatorMatrixExtractorTests.allTests),
        testCase(SimulatorOracleMatrixExtractorTests.allTests),
        testCase(SimulatorOracleMatrixAdapterTests.allTests),
