//
//  CSMFullMatrixDensityMatrixTransformationTests.swift
...
class CSMFullMatrixDensityMatrixTransformationTests: XCTestCase {

    // MARK: - Tests

    func testMaxConcurrencyEqualToZero_init_throwException() {
        // Then
        XCTAssertThrowsError(try CSMFullMatrixDensityMatrixTransformation(expansionConcurrency: 0))
    }

    func testMatrixFactoryReturnsMatrix_applying_returnValue() {
        // Given
        let adapter = try! CSMFullMatrixDensityMatrixTransformation(expansionConcurrency: 1)
