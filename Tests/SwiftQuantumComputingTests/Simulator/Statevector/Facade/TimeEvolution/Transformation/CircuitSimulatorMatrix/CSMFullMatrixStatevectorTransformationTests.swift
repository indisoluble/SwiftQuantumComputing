//
//  CSMFullMatrixStatevectorTransformationTests.swift
...
class CSMFullMatrixStatevectorTransformationTests: XCTestCase {
    ...
    func testMatrixFactoryReturnsMatrix_applying_returnValue() {
        ...
        // When
        let result = adapter.apply(matrix: circuitMatrix, toStatevector: vector)
