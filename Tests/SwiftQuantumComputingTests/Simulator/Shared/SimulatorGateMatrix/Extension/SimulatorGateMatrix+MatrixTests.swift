...
class SimulatorGateMatrix_MatrixTests: XCTestCase {
    ...
    func testSingleQubitMatrix_matrix_returnExpectedMatrix() {
        ...
        // When
        let result = SimulatorGateMatrix.singleQubitMatrix(matrix: matrix).matrix
    ...
    func testNotMatrixAndControlCountToOne_matrix_returnExpectedMatrix() {
        ...
        // When
        let result = SimulatorGateMatrix.fullyControlledSingleQubitMatrix(controlledMatrix: controlledMatrix,
