...
extension CircuitViewDescription: CustomStringConvertible {
    var description: String {
        return "Circuit with \(qubitCount) qubits & \(layerCount) gates"
    }
}
...
extension CircuitViewDescription: CircuitDescription {
    func applyingGate(_ gate: Gate) -> CircuitViewDescription {
        let layer = gate.makeLayer(qubitCount: qubitCount)
